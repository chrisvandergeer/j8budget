 ...
 */
public class ImportTransaktieControllerTest {

    private Stream<Transaktie> stream;

    @Before
    public void setup() {
        ImportTransaktieController bestand = new ImportTransaktieController();
        stream = bestand.execute("csvinput.csv").getWrappedTransakties().stream();
    }
